# Vivado TCL: Sigmoid on Zybo Z7-10 (simple version, no BRAM)
# Usage: vivado -mode batch -source build.tcl

# Fix Windows sub-process journal path issue (writes to C: otherwise)
...
set project_name "sigmoid_project"
