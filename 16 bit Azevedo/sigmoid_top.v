module sigmoid_top #(
    ...
    // AXI4-Lite slave (PS7 register access)
    ...
    // 0x00: X_REG      - write input x (Q4.12), read current x
    // 0x04: Y_REG      - read output y (Q4.12)
    // 0x08: CTRL       - bit 0 = start
    // 0x0C: STATUS     - bit 0 = busy, bit 1 = done
    // 0x10: RESULT_REG - read result after processing
    ...
    // Processing FSM
    // Pipeline: LOAD -> WAIT_SIGMOID -> STORE
