...
%GCC% -mcpu=cortex-a9 -c "%OUT%\ddr_init\startup.S" -o "%OUT%\test_startup.o"
...
echo Linking...
%GCC% %FLAGS% -Wl,--build-id=none -T "%OUT%\ddr_init\lscript_ocm.ld" -nostartfiles "%OUT%\test_startup.o" "%OUT%\test_ps7_init.o" "%OUT%\test_main.o" -lgcc -lc -o "%OUT%\testSoft.elf"
if errorlevel 1 goto :fail
